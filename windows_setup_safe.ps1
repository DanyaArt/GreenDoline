# Windows 11 Home Server Setup - Safe Version
...
if ($wslEnabled.State -eq "Enabled" -and $vmPlatformEnabled.State -eq "Enabled") {
    Write-Host "WSL2 is already enabled!" -ForegroundColor Green
} else {
    Write-Host "WSL2 is not enabled yet." -ForegroundColor Yellow
    Write-Host "You need to enable WSL2 manually:" -ForegroundColor Cyan
    Write-Host "1. Open PowerShell as Administrator" -ForegroundColor White
    Write-Host "2. Run: dism.exe /online /enable-feature /featurename:Microsoft-Windows-Subsystem-Linux /all" -ForegroundColor White
    Write-Host "3. Run: dism.exe /online /enable-feature /featurename:VirtualMachinePlatform /all" -ForegroundColor White
    Write-Host "4. Restart your computer" -ForegroundColor White
    Write-Host "5. Run: wsl --install -d Ubuntu" -ForegroundColor White
}
...
try {
    ...
    Write-Host "WSL2 is not running. Please enable WSL2 first." -ForegroundColor Red
    pause
    exit
}
...
IMPORTANT: Enable WSL2 manually to avoid blue screen!
...
Write-Host "1. Enable WSL2 manually (see instructions above)" -ForegroundColor White
Write-Host "2. Restart computer" -ForegroundColor White
Write-Host "3. Read file: C:\server\WSL2_SETUP.md" -ForegroundColor White
Write-Host "4. Follow instructions" -ForegroundColor White
Write-Host "5. Start server: C:\server\start_server.bat" -ForegroundColor White
Write-Host "================================================" -ForegroundColor Yellow
